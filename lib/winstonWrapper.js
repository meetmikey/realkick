...
winston.setErrorType = function(winstonError, type) {
  if ( ! winstonError ) {
    return;
  }
  if( Object.prototype.toString.call( winstonError.extra ) !== '[object Object]' ) {
    winstonError.extra = {};
  }
...
winston.getErrorType = function (winstonError) {
  if (!winstonError || !winstonError.extra) {
    ...
    return winstonError.extra.errorType;
  }
}
...
winston.addExtra = function( winstonError, newExtra ) {
